// rnwturboExample.cpp : Defines the entry point for the application.
//

#include "pch.h"
#include "rnwturboExample.h"
...
// Global Variables:
constexpr PCWSTR windowTitle = L"RnwturboExample";
constexpr PCWSTR mainComponentName = L"RnwturboExample";
